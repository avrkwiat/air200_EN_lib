...
--Module function: indicator display control
...
--1-5, the priority from low to high:
--IDLE: three lights long off
--LOWPWR: low battery, red light flashes 1 second 1 second, the other lights off
--CHGING: charging, the red light is always on, the remaining lights off
--SHORTKEY: Short press, the green light flashes once
--LONGKEY: long press, blue light flash once
--1-3, Status:
--INACTIVE: Inactive
--PEND: waiting to be activated
--ACTIVE: activated

local IDLE,LOWPWR,CHGING,SHORTKEY,LONGKEY,PRIORITYCNT = 1,2,3,4,5,5
local INACTIVE,PEND,ACTIVE = 1,2,3
local tcause = {}
-- Sorted in red, green and blue, each lamp occupies two positions, each position can be set to take effect, whether it is lit, and the corresponding time (default 1 second)
