...
-- Ali cloud East China 2 node to create a productKey, users create their own projects in Aliyun, according to their own project information, modify this value
local PRODUCT_KEY = "b0FMK1Ga5cp"

-- In addition to PRODUCT_KEY above, DEVICE_NAME and DEVICE_SECRET are required
