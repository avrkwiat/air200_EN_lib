...
--1, every 10 seconds to send a GET command to the background, regardless of the success or failure of the transmission, are disconnected after 5 seconds;
...
--Function: The GET command sends a callback, starts the timer, and sends the GET command again after 10 seconds
--Parameters:
